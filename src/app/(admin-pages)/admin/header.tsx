    ...
    <div className="navbar bg-base-100 px-10 shadow-md shadow-black/10">
      ...
      <div className="flex-none">
        <ul className="menu menu-horizontal gap-3 px-1">
          <li>
            <Link href={AdminRoute.Dashboard}>Dashboard</Link>
          </li>
          <li>
            <Link className="pointer-events-none" href={AdminRoute.POS}>
              POS
            </Link>
          </li>
          <li>
            <details>
              ...
              <ul className="right-0 w-52 bg-base-100 p-2">
                <div className="px-4 py-2">
                  <div className={twJoin(inter.className, 'font-semibold')}>
                    {session?.user.name}
                  </div>
                  <div className="text-black/50">{session?.user.role}</div>
                  <div className="text-black/50">{session?.user.email}</div>
                </div>
                <div className="my-2 border-b border-black/10" />
                <li>
                  <Link className="pointer-events-none" href={AdminRoute.Settings}>
                    Settings
                  </Link>
                </li>
                <li>
