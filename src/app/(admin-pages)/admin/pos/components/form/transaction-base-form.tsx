...
const TransactionBaseForm = ({
  ...
  const onChangeVehicleSize = (selectedVehicleSize: VehicleSize) => {
    form.setValue('vehicleSize', selectedVehicleSize);

    const transactionServices = [...formState.transactionServices];
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="w-full ">
              ...
              <Select onValueChange={onChangeVehicleSize} value={field.value}>
                <FormControl>
                  <SelectTrigger>
